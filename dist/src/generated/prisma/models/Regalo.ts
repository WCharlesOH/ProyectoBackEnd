...
// @ts-nocheck 
/*
 * This file exports the `Regalo` model and its related types.
 *
...
export type GetRegaloAggregateType<T extends RegaloAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateRegalo[P]>
    : Prisma.GetScalarType<T[P], AggregateRegalo[P]>
}
...
type GetRegaloGroupByPayload<T extends RegaloGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<RegaloGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof RegaloGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], RegaloGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], RegaloGroupByOutputType[P]>
      }
    >
  >
...
export type RegaloCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface RegaloDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends RegaloCountArgs>(
    args?: Prisma.Subset<T, RegaloCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], RegaloCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, RegaloGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetRegaloGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
