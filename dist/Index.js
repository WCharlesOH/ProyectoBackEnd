...
app.post("/api/stream/room", (req, res) => {
...
app.get("/api/stream/status/:streamerName", (req, res) => {
...
app.get("/api/live-broadcaster", (req, res) => {
...
app.post("/api/live-room/create", async (req, res) => {
...
// ===========================================
app.post("/Contar_Espectadores_Actuales", async (req, resp) => {
    try {
...
app.post("/Contar_Seguidores_Totales", async (req, resp) => {
    try {
        const { ID_Streamer } = req.body;
        if (!ID_Streamer) {
            return resp.status(400).json({ error: "ID_Streamer es requerido" });
...
app.post("/Estadisticas_Streamer", async (req, resp) => {
    try {
        const { ID_Streamer } = req.body;
        if (!ID_Streamer) {
            return resp.status(400).json({ error: "ID_Streamer es requerido" });
...
app.post("/Lista_Espectadores_Actuales", async (req, resp) => {
    try {
        const { ID_Streamer } = req.body;
        if (!ID_Streamer) {
            return resp.status(400).json({ error: "ID_Streamer es requerido" });
        ...
        const listaFormateada = espectadores.map((e) => ({
...
app.get("/Top_Streamers_Por_Espectadores", async (req, resp) => {
    try {
        ...
        const ranking = streamersEnVivo
            ...
            .sort((a, b) => b.espectadoresActuales - a.espectadoresActuales);
        resp.status(200).json({
...
// ============================================
app.post("/Registrar_Usuario", async (req, resp) => {
    try {
        const { NombreUsuario, Contraseña, email, ImagenPerfil, } = req.body;
...
app.post("/Validar_Usuario", async (req, resp) => {
    try {
...
app.post("/Suscrito", async (req, resp) => {
    try {
...
app.post("/SuscripcioneMias", async (req, resp) => {
    try {
        const { ID_Streamer } = req.body;
...
app.post("/Crear_Suscripcion", async (req, resp) => {
    try {
...
app.post("/Eliminar_Suscripcion", async (req, resp) => {
    try {
        const { ID_Streamer, ID_Viewer } = req.body;
...
app.post("/Crear_ChatStreamer", async (req, resp) => {
    try {
        const { ID_Streamer, ID_Viewer } = req.body;
...
app.post("/ObtenerDatosUsuario", async (req, resp) => {
    try {
        const { ID_Usuario } = req.body;
...
app.post("/ObtenerDatosUsuarioNombre", async (req, resp) => {
    try {
...
app.post("/VIendoDirecto", async (req, resp) => {
    try {
...
app.post("/ObtenerDatosChat", async (req, resp) => {
    try {
...
app.post("/Actualizar_NivelViewer", async (req, resp) => {
    try {
...
app.post("/Actualizar_NivelStreams", async (req, resp) => {
    try {
...
app.post("/Actualizar_HorasTransmision", async (req, resp) => {
    try {
...
app.get("/UsuariosRanking", async (req, resp) => {
    try {
...
app.post("/Asignar_Logro", async (req, resp) => {
    try {
...
app.post("/LogrosUsuario", async (req, resp) => {
    try {
        const { ID_Usuario } = req.body;
...
app.get("/LogrosPlantilla", async (req, resp) => {
    try {
...
app.post("/Actualizar_Logro", async (req, resp) => {
    try {
...
app.post("/Todos_Los_Logros", async (req, resp) => {
    try {
        const { ID_Usuario } = req.body;
...
// ============================================
app.get("/ObtenerJuegos", async (req, resp) => {
    try {
...
app.post("/StreamersPorJuego", async (req, resp) => {
    try {
        ...
        const streamersEnVivo = videosConJuego
            .filter((v) => v.Vedeo?.Estado === true && v.Vedeo?.usuario?.EnVivo === true)
            .map((v) => ({
...
app.get("/Mas_Vistos", async (req, res) => {
    try {
...
app.get("/Mas_Visto", async (req, res) => {
    try {
        const streamers = await prisma.usuario.findMany({
            where: {
                EnVivo: true
...
app.post("/SeguidosEnVIvo", async (req, resp) => {
    try {
        const { ID_Usuario } = req.body;
...
app.post("/Actualizar_Estado_EnVivo", async (req, resp) => {
    try {
...
app.post("/Actualizar_Monedas", async (req, resp) => {
    try {
...
app.post("/datos_Stream", async (req, resp) => {
    try {
        const { ID_Usuario } = req.body;
...
// ENDPOINTS DE VIDEOS
// ============================================
app.post("/Crear_VIdeo", async (req, resp) => {
    try {
...
app.post("/Vincular_Juego_Video", async (req, resp) => {
    try {
...
app.post("/Actualizar_Video", async (req, resp) => {
    try {
...
app.post("/Eliminar_Video", async (req, resp) => {
    try {
...
app.post("/VerMisVideos", async (req, resp) => {
    try {
        const { ID_Usuario } = req.body;
...
app.get("/videos/buscar", async (req, resp) => {
...
app.get("/buscar/usuarios", async (req, resp) => {
    const busqueda = req.query.q;
    if (!busqueda || busqueda.trim() === "") {
        return resp.status(400).json({
...
app.get("/buscar/categorias", async (req, resp) => {
    const busqueda = req.query.q;
    if (!busqueda || busqueda.trim() === "") {
        return resp.status(400).json({
            error: "Escribe algo para buscar"
...
// ============================================
app.post("/regalos/crear", async (req, resp) => {
...
app.get("/regalos/eliminar", async (req, resp) => {
    const nombreParaBorrar = req.query.nombre;
    if (!nombreParaBorrar) {
...
app.post("/regalos/actualizar", async (req, resp) => {
    const data = req.body;
    const id = data.id;
    try {
...
app.post("/regalos", async (req, resp) => {
    try {
        const { id } = req.body;
...
app.get("/regalosbyMirko", async (req, resp) => {
    try {
...
app.get("/api/chat/:streamerName/mensajes", (req, res) => {
...
app.post("/api/chat/:streamerName/mensaje", (req, res) => {
...
app.delete("/api/chat/:streamerName/limpiar", (req, res) => {
...
app.get("/api/chat/:streamerName/stats", (req, res) => {
